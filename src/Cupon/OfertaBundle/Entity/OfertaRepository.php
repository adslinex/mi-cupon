...
class OfertaRepository extends EntityRepository
{
    ...
    public function findOfertaDelDia($ciudad)
    {
       ...
       //echo 'Dentro de Oferta del dia para '.$ciudad;
          
        $em = $this->getEntityManager();
// WHERE o.revisada = true AND o.fecha_publicacion < :fecha AND c.slug = :ciudad    QUITO LA FECHA
        $consulta = $em->createQuery('
            SELECT o, c, t
            FROM OfertaBundle:Oferta o JOIN o.ciudad c JOIN o.tienda t
            WHERE o.revisada = true AND c.slug = :ciudad
